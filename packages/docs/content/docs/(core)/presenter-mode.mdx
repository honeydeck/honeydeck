...
- Button to cast the audience view to a secondary display when supported; the same control becomes a stop button while casting and shows clear unavailable feedback when unsupported
