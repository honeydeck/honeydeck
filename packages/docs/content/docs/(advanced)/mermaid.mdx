...
> **Runnable demo:** Use the [`demos/mermaid`](https://github.com/honeydeck/honeydeck/tree/main/demos/mermaid) project on GitHub to try this setup in a complete Honeydeck deck.

![Mermaid demo Slide](/images/demo-mermaid.png)
...
For a runnable example, see [`demos/mermaid`](https://github.com/honeydeck/honeydeck/tree/main/demos/mermaid) on GitHub.
