...
export function honeydeckPlugin(
	...
	return [
		// ── Layer 0: dependency optimizer hints ─────────────────────────
		//
		// Runtime imports resolve through @honeydeck/runtime package exports.
		// Do not alias them to file-system paths; that would create a second
		// runtime module identity beside deck-authored package imports.
		{
			name: "honeydeck:runtime-optimizer",
			config() {
				return {
					optimizeDeps: {
						include: [
