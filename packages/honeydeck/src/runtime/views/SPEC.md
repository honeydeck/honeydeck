...
- Presenter slide previews render on the same themed `bg-background` slide backdrop as the audience view so transparent layouts still show the effective light/dark deck background.
